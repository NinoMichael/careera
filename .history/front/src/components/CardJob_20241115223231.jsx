        ...
        <>
            ...
            <section className="grid grid-cols-3">
                <div className='bg-blackCustom text-white text-[0.65em] h-8 rounded'>
                    <p className='-mt-1 font-poppins'><i className='pi pi-map-marker mt-2 mx-1'></i>Antananarivo</p>
                </div>
                <div className='bg-blackCustom text-white text-[0.65em] h-8 rounded w-16'>
                    <p className='-mt-1 font-poppins'>CDD</p>
                </div>
                <div className='bg-blackCustom text-white text-[0.65em] h-8 rounded'>
                    <p className='-mt-1 font-poppins'>Remote</p>
                </div>
            </section>
