...
const VMenu = () => {
    ...
    let items = [
        {
            template: () => {
                return (
                    <div className="my-3 cursor-pointer" onClick={toggleMenu}>
                        <img src={logo} alt="Logo" width={150} height={150} className={`mx-auto flex justify-center items-center ${collapsed ? 'w-12 h-12' : 'w-24 h-20'}`} />
                    </div>
                )
            }
        },
    ...
    return (
        <div className={`fixed float-left -mt-1 ${collapsed ? 'w-[5vw]' : 'w-[17vw]'}`}>
