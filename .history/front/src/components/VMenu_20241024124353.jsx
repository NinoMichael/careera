...
const VMenu = () => {
    ...
    const itemRenderer = (item) => (
        <div className='p-menuitem-content ps-4 hover:bg-greenCustom hover:text-white rounded mb-5'>
    ...
    let items = [
        {
            template: () => {
                return (
                    <div className="my-3">
                        <img src={logo} alt="Logo" width={150} height={150} className="w-24 h-20 mx-auto flex justify-center items-center cursor-pointer" />
                    </div>
                )
            }
        },
