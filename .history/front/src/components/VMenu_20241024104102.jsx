...
const VMenu = () => {
    ...
    const itemRenderer = (item) => (
        <div className='p-menuitem-content ps-4 hover:bg-greenCustom'>
            <Link className="flex align-items-center p-menuitem-link text-black py-2 rounded space">
    ...
    return (
        <div className="fixed float-left -mt-1 w-[7vw]">
