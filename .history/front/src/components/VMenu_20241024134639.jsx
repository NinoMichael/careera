...
const VMenu = () => {
    ...
    const itemRenderer = (item) => (
        <div className={`p-menuitem-content ps-4 hover:bg-greenCustom hover:text-white rounded ${collapsed ? 'justify-center mb-10' : 'mb-5'}`}>
        ...
        },
        {
            template: () => {
                return (
                    <>
                        {collapsed ? (
                            <i className="pi pi-sun mt-12 text-center flex justify-center items-center ms-7"></i>
                        ) : (
