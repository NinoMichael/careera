    ...
    const jobs = [
        {
            ...
            typeContract1: "CDD",
            typeContract2: "Local",
            description: "Basé à Antananarivo, ce poste offre l'opportunité de travailler sur des projets variés pour des clients de renom. Intégrez une entreprise en pleine croissance, où votre talent sera valorisé.",
        },
    ]
        ...
        <div className="grid grid-cols-3 gap-4">
            {jobs.map((job) => (
                <Card key={job.id} header={() => header(job)} footer={footer} className='py-0 px-5'>
                    <div className='h-20'>
                        <p className='text-sm font-poppins'>{job.description}</p>
                    </div>
                </Card>
            ))}
        </div>
