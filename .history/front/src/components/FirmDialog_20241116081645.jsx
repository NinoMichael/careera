            ...
            content={({ hide }) => (
                <>
                    ...
                    <div className="flex flex-row justify-between">
                        <div className="flex flex-row justify-start ms-6 mt-3">
                            <Avatar image={axian} shape="circle" size="large" />
                        </div>

                        <Button label="Contacter" icon="pi pi-phone" className="font-poppins text-xs text-white border border-none outline outline-none bg-greenCustom h-8" />
                    </div>
                </>
            )}>
