...
const CardJob = ({visibleFirm, setVisibleFirm}) => {
    const jobs = [
        {
            id: 1,
            title: "Web Designer",
        ...
        <>
            <section className="flex flex-row justify-between">
                <div className="flex flex-row items-center">
                    <div className='cursor-pointer' onClick={() => setVisibleFirm(true)}>
                        <Avatar image={job.imgFirm} shape="circle" />
                    </div>
                    <div className="ml-4 -mt-3">
                        <h6 className="font-poppins font-normal text-[0.8em] cursor-pointer" onClick={() => setVisibleFirm(true)}>{job.firm}</h6>
