    ...
    const header = (job) => (
        <>
            ...
            <section className="grid grid-cols-3">
                <div className='bg-blackCustom text-white text-[0.75em] h-8 rounded'>
                    <span className='mt-1 font-poppins'><i className='pi pi-map-marker ms-1 me-2'></i>Antananarivo</span>
                </div>
            </section>
