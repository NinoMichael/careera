...
const MenuUser = () => {
    ...
    const authBtn = (
        <div className="flex ms-20 space-x-3">
            ...
            <Link to="/register-email"><Button label={t('register')} className="bg-blackCustom  text-white font-poppins border border-none outline outline-none text-sm max-sm:text-xs" /></Link>
        </div>
    )
