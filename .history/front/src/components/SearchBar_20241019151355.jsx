        ...
        <div className={className}>
            <FloatLabel className="relative focus-within:text-white">
                <Dropdown value={domain} onChange={(e) => setDomain(e.value)} options={domain} optionLabel="intitule"
                    filter valueTemplate={domainTemplate} panelClassName="font-poppins text-sm" className="w-36 font-poppins text-sm bg-white border custom-p-dropdown-trip border-slate-400" />
                <label htmlFor="dd-domain" className="text-sm -mt-3"><i className="pi pi-map-marker  text-sm me-1"></i> {t('departure')}</label>
            </FloatLabel>
        </div>
    )
}
