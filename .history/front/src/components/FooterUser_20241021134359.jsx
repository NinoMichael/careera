...
const FooterUser = () => {
    ...
    return (
        <footer className="mt-20 bg-blackCustom p-4">
            ...
            <section className="flex justify-center items-center space-x-32 mt-8 mx-48">
                <div className="flex justify-center space-x-8">
                    <i className="pi pi-facebook text-white"></i>
                    <i className="pi pi-whatsapp text-white"></i>
                    <i className="pi pi-twitter text-white"></i>
                </div>

                <span className="text-xs text-center">{t('copyright')}</span>
            </section>
