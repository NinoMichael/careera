...
const ToolBar = () => {
    ...
    const handleLanguageChange = (e) => {
        switchLanguage(e.value)  // e.value doit être le code de langue sélectionné
    }
    ...
    const centerContent = (
        <div className="space-x-24">
            ...
            <div className="flex items-center space-x-3 -mt-7 ms-12">
                ...
                <Dropdown
                    value={language}  // Assurez-vous que language est un des codes (ex: 'FR', 'EN', 'MG')
                    options={langOptions}
                    onChange={handleLanguageChange}
                    optionLabel="name"  // Afficher les noms (Français, English, etc.)
                    placeholder={language.name}  // Utilisez le nom de la langue pour le placeholder
