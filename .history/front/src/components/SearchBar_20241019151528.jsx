        ...
        <div className={className}>
            <FloatLabel className="relative focus-within:text-white">
                <Dropdown value={domain} onChange={(e) => setDomain(e.value)} options={domain} optionLabel="intitule"
                    filter valueTemplate={domainTemplate} panelClassName="font-poppins text-sm" className="w-36 h-10 rounded font-poppins text-sm bg-white border custom-p-dropdown-trip border-slate-400" />
