    ...
    const header = (job) => (
        <>
            ...
            <section className="grid grid-cols-3 space-x-4">
                <div className='bg-blackCustom text-white text-[0.65em] h-8 rounded w-20'>
                    <p className='mt-0 font-poppins text-center '>Emploi</p>
                </div>
                <div className='bg-blackCustom text-white text-[0.65em] h-8 rounded w-16'>
                    <p className='mt-0 font-poppins'>CDD</p>
                </div>
                <div className='bg-blackCustom text-white text-[0.65em] h-8 rounded w-16'>
                    <p className='mt-0 font-poppins'>Remote</p>
                </div>
            </section>
