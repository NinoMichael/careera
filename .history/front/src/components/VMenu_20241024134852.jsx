...
const VMenu = () => {
    ...
    const itemRenderer = (item) => (
        <div className={`p-menuitem-content ps-4 hover:bg-greenCustom hover:text-white rounded ${collapsed ? 'justify-center mb-6' : 'mb-5'}`}>
        ...
        },
        {
            template: () => {
                return (
                    <>
                        {collapsed ? (
                            <i className="pi pi-sun mt-16 text-center flex justify-center items-center ms-7 cursor-pointer"></i>
                        ) : (
