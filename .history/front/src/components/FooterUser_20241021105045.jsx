        ...
        <footer className="mt-20 bg-blackCustom">
            <section className="grid grid-cols-4">
                ...
                <div>
                    ...
                    <Link to="/recruit"><p className="text-xs text-white">{t('recruit')}</p></Link>
                </div>

                <div>
                    <h4 className="font-kanit text-white text-base">{t('quickLinks')}</h4>
                    <Link to="/home"><p className="text-xs text-white">FAQs</p></Link>
                    <Link to="/home"><p className="text-xs text-white">{t('useConditions')}</p></Link>
                    <Link to="/recruit"><p className="text-xs text-white">{t('privacyPolicy')}</p></Link>
                </div>
