...
const ToolBar = () => {
    ...
    return (
        <>
            <header className="mt-4 flex justify-between ps-64 pe-6 bg-greenCustom h-[4.75rem]">
                <div>
                    <h1 className="text-white text-2xl font-poppins italic mt-7">Find your dream job here</h1>
                </div>
