            ...
            <section className="flex flex-row justify-between">
                <div className="flex flex-row items-center">
                    ...
                    <div className="ml-4 -mt-3">
                        <h6 className="font-poppins font-normal text-[0.8em] cursor-pointer">{job.firm}</h6>
                        <p className='-mt-9 text-xl font-semibold font-kanit cursor-pointer'>{job.title}</p>
