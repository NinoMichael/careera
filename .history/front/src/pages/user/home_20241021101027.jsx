        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main className="mt-5 mx-4">
                ...
                <section className="mt-24 mx-40 bg-greenCustom shadow rounded text-white py-8 px-36">
                    ...
                    <div className="p-inputgroup flex-1 mt-8 mx-20">
                        <FloatLabel>
                            <InputText type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="font-poppins text-sm" />
                            <label htmlFor="email">{t('emailAddress')}</label>
                        </FloatLabel>
                        <Button label={t('search')} className="font-poppins text-sm bg-blackCustom border border-none outline outline-none" />
                    </div>
                </section>
            </main>
        </motion.div >
