    ...
    return (
        <div className="overflow-y-hidden">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="overflow-y-hidden">
                ...
                <main className="bg-white shadow-lg rounded flex justify-normal mx-auto mt-8 w-[65%] h-[65vh]">
                    ...
                    <section className="flex flex-col justify-center mx-auto text-center">
                        ...
                        <p className="mt-2 text-center w-80">{t('introRegister')}</p>
                        <Button label={t('begin')} className="border border-none outlline outline-none w-full font-poppins text-sm mt-6 bg-greenCustom" />
                    </section>
                </main>
