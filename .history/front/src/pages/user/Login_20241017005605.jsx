            ...
            <main className="flex justify-between mx-auto mt-4 shadow-lg rounded w-[65%] h-[77.5vh]">
                ...
                <section className="px-12 py-4 justify-center">
                    ...
                    <form className="mt-8">
                        ...
                        <Button label={t('login')} type="submit" className="bg-greenCustom text-white mt-10 ms-5 font-poppins border border-none outline outline-none rounded py-2 w-full" />
                        ...
                        <div className="mt-12 flex justify-center items-center mx-auto">
                            <Button label={t('googleSignin')} className="bg-blackCustom text-white font-poppins text-sm rounded border border-none outline outline-none py-2 w-full"
