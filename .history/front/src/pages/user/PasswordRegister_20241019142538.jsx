                ...
                <section className="flex flex-col justify-center mx-auto text-center">
                    ...
                    <form className="mt-4 mx-16">
                        ...
                        <div className="justify-start flex mt-6">
                            ...
                            <label htmlFor="accept" className="ml-2 text-xs">{t('agreeWith')} <Link to="/use-conditions" className="text-blackCustom text-underline">{t('useCondition')}</Link> {t('and')}</label>
                        </div>
                    </form>
                </section>
            </main>
