        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main className="mt-5 mx-4">
                ...
                <article className="mt-20 mx-16">
                    ...
                    <div className="grid <div className=" grid grid-cols-[50%,30%] mt-9"> mt-9">
                    <div className="grid grid-cols-2 space-x-3">
                        {reasons.map((reason) => (
                            <Card key={reason.id} className="bg-white border rounded font-poppins">
                                <h2 className="font-poppins text-lg">{reason.title}</h2>
