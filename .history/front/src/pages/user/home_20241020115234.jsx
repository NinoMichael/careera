            ...
            <main className="mt-5 mx-4">
                <header className="mx-2 bg-blackCustom grid grid-cols-2 py-6 px-24 rounded-lg">
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-greenCustom absolute flex flex-row space-x-2 justify-start p-2 rounded h-12 right-8 top-72">
                            <i className="pi pi-briefcase text-white"></i>
                            <div className="-mt-12">
                                <h6 className="text-slate-200">{t('everyday')}</h6>
                                <p className="-mt-6v text-white">{t('totalJob')}</p>
                            </div>
                        </div>
                    </div>
