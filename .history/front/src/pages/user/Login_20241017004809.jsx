            ...
            <main className="flex justify-between mx-auto mt-8 shadow-lg rounded w-[65%] h-[70vh]">
                ...
                <section className="px-5 justify-center mx-auto">
                    ...
                    <form className="mt-8">
                        ...
                        <Button label={t('login')} type="submit" className="bg-greenCustom text-white mt-10 ms-6 font-poppins border border-none outline outline-none rounded py-2 px-32" />
