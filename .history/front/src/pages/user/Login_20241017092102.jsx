    ...
    return (
        <div className="overflow-hidden">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} >
                <div className="mt-6 mx-12 flex justify-between overflow-hidden">
                    <i className="pi pi-arrow-left cursor-pointer" onClick={() => navigate('/home')} title="Retour"></i>
                    <DropdownLang className="flex space-x-8" />
                </div>

                <main className="flex justify-between mx-auto mt-1 shadow-lg rounded w-[65%] h-[85vh] overflow-hidden">
                    <section className="mt-4 bg-greenCustom w-96">
                        <img src={imgLogin} alt="Login" className="w-64 h-52 mx-auto items-center flex justify-center mt-28" />
                    </section>
                    ...
                    <section className="px-12 py-4 justify-center">
                        ...
                        <form className="mt-8 overflow-hidden">
