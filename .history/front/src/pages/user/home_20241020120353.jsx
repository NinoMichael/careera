                ...
                <header className="mx-2 bg-blackCustom grid grid-cols-2 py-6 px-24 rounded-lg">
                    ...
                    <div>
                        <Link to="https://www.linkedin.com">
                            <img src={linkedin} className="absolute w-10 h-10 right-52 top-48 cursor-pointer z-10" alt="Linkedin" />
                        </Link>
                        ...
                        <div className="bg-greenCustom flex flex-row space-x-2 justify-start p-2 rounded h-12 ms-[26rem] w-36 -mt-1">
