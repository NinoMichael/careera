                ...
                <section className="px-12 py-4 justify-center">
                    ...
                    <form className="mt-8">
                        ...
                        <div className="mt-12 flex justify-center items-center mx-auto">
                            <Button label={t('googleSignin')} className="bg-blackCustom text-white font-poppins text-sm rounded border border-none outline outline-none py-2 pe-12 w-full"
                                icon="pi pi-google text-white ms-48" />
                        </div>
