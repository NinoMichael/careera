        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="overflow-y-hidden" >
            ...
            <main className="bg-white shadow-lg rounded flex justify-normal mx-auto mt-10 w-[65%] h-[75vh]">
                <section className="bg-greenCustom p-6 w-96">
                    <img src={logo} alt="Careera" className="w-52 h-48 flex justify-center items-center mx-auto mt-12 p-6 bg-white rounded-full" />
                </section>
                    ...
                    <form className="mt-5 mx-auto">
                        ...
                        <section className="flex flex-row space-x-4 mx-20 mt-8">
                            <div className="p-inputgroup flex-1">
                                ...
                                <FloatLabel>
                                    <Calendar value={birth} onChange={(e) => setBirth(e.value)} />
                        ...
                        <Button label={t('next')} className="border border-none outlline outline-none mx-auto w-96 font-poppins text-sm mt-10 mb-4 bg-greenCustom" />
                    </form>
                </section>
            </main>
        </motion.div >
