        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main className="mt-5 mx-4">
                ...
                <section className="mt-16 mx-16">
                    ...
                    <Button label={t('seeMore')} className="mt-12 flex justify-center items-center mx-auto font-poppins text-white text-sm bg-blackCustom border border-none outline outline-none" />
                </section>
            </main>
        </motion.div>
    )
