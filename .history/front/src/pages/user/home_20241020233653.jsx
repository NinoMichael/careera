    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main className="mt-5 mx-4">
                ...
                <section className="mt-24 mx-40 bg-greenCustom text-white py-8 px-12">
                    <h1 className="text-center mt-6 text-xl">{t('subscribeTitle')}</h1>
                    <p className="text-center mx-24">{t('subscribeTxt')}</p>
                </section>
            </main >
        </motion.div >
    )
