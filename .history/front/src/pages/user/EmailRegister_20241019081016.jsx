                    ...
                    <form className="mt-2 mx-auto">
                        <section className="flex flex-row">
                            <div className="p-inputgroup flex-1">
                                ...
                                <FloatLabel>
                                    <InputText type="nom" value={nom} onChange={(e) => setNom(e.target.value)} className="font-poppins text-sm" />
                                    <label htmlFor="nom">{t('emailAddress')}</label>
                                </FloatLabel>
                            </div>
                            ...
                            <div className="p-inputgroup flex-1">
                                ...
                                <FloatLabel>
                                    <InputText type="prenom" value={prenom} onChange={(e) => setPrenom(e.target.value)} className="font-poppins text-sm" />
