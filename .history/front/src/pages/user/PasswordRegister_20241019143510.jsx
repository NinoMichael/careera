                ...
                <section className="flex flex-col justify-center mx-auto text-center">
                    ...
                    <form className="mt-4 mx-16">
                        ...
                        <div className="justify-start flex mt-6">
                            ...
                            <label htmlFor="accept" className="ml-2 text-[0.7em]">{t('agreeWith')} <Link to="/use-conditions" className="text-blackCustom text-underline">{t('useCondition')}</Link> {t('and')} <Link to="/privacy-policy" className="text-blackCustom text-underline">{t('privacyPolicy')}</Link></label>
                        </div>

                        <Button label={t('submit')} className="mt-6 font-poppins text-sm border border-none outline outline-none bg-greenCustom w-full mt-4" />
                    </form>
                </section>
            </main>
