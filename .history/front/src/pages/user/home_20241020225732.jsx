        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main className="mt-5 mx-4">
                ...
                <article className="mt-20 mx-24">
                    ...
                    <div className="flex flex-row space-x-5 justify-center items-center mx-auto mt-6">
                        <AvatarGroup>
                        ...
                        <Button label={t('publishOffer')} className="bg-greenCustom font-poppins text-sm border border-none outline outline-none" />
                    </div>
                </article>
            </main >
        </motion.div >
