            ...
            <main className="flex justify-between mx-auto mt-8 shadow-lg rounded w-[65%] h-[70vh]">
                ...
                <section className="px-5 justify-center mx-auto">
                    ...
                    <form className="mt-8">
                        ...
                        <Button label={t('login')} type="submit" className="bg-greenCustom text-white mt-10 ms-4 font-poppins border border-none outline outline-none rounded py-2 px-32" />
                        ...
                        <div className="mt-12 flex justify-center items-center mx-auto">
                            <Button label={t('googleSignin')} className="bg-blackCustom text-white font-poppins text-sm rounded border border-none outline outline-none px-12 py-2"
