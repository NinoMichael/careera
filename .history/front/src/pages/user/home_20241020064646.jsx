        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <main className="mt-5 mx-4">
                <header className="mx-2 bg-blackCustom grid grid-cols-2 py-6 px-24 rounded-lg">
                    ...
                    <div className="relative bg-white rounded h-44 w-80 mt-32 mx-auto">
                        <img src={promo} width={400} height={400} alt="Promo" className="w-[140%] h-80 absolute right-auto left-auto -top-36" />
                    </div>
                </header>
            </main>
        </motion.div>
