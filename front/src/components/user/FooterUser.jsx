        ...
        <footer className="mt-20 bg-blackCustom p-4">
            <section className="grid grid-cols-3 mx-48">
                ...
                <div>
                    ...
                    <Link to="/recruit" className=" no-underline"><p className="text-xs text-white">{t('recruitTxt')}</p></Link>
                </div>
                ...
                <div>
                    ...
                    <Link to="/recruit" className=" no-underline"><p className="text-xs text-white">{t('privacy2Policy')}</p></Link>
                </div>
            </section>
