        ...
        <Dialog visible={visibleFirm} className="pt-4 pb-6 px-6 rounded bg-white h-[85vh] w-[60vw] overflow-y-auto"
            ...
            content={({ hide }) => (
                <>
                    ...
                    <div className="flex flex-row justify-between">
                        <div className="flex flex-row justify-start space-x-4 ms-6 mt-3">
                            ...
                            <div className="-mt-4">
                                ...
                                <p className="font-poppins text-xs -mt-5">La compagnie à votre services</p>
                            </div>
                        </div>
                    ...
                    <section className="grid grid-cols-2 mx-6 -mt-4 space-x-8 relative overflow-y-auto">
                        <div className="overflow-y-auto">
                            ...
                            <div className="mt-10">
                                ...
                                <section className="mt-4">
                                    {jobFirms.map((jobFirm) => (
                                        <div key={jobFirm.id} className="bg-slate-50 rounded p-3 mb-4 shadow">
                                            <div className="flex flex-row justify-between">
                                                <div className="-mt-3">
                                                    <h3 className="font-kanit">{jobFirm.titleJob}</h3>
                                                </div>

                                                <div>
                                                    <i className="pi pi-ellipsis-v cursor-pointer mt-4" title="Options"></i>
                                                </div>
                                            </div>

                                            <div className="flex flex-row justify-start space-x-8">
                                                <Chip label={jobFirm.typeJob} className="bg-blackCustom font-poppins text-[0.65em] text-white" />
                                                <Chip label={jobFirm.typeContrat1} className="bg-blackCustom font-poppins text-[0.65em] text-white" />
                                                <Chip label={jobFirm.typeContrat2} className="bg-blackCustom font-poppins text-[0.65em] text-white" />
                                            </div>
                                        </div>
                                    ))}
                        ...
                        <div>
                            ...
                            <div className="bg-white rounded shadow-lg p-4">
                                {firms.map((firm) => (
                                    <div key={firm.id} className="flex flex-row justify-between mb-3">
                                        <div className="-mt-6">
