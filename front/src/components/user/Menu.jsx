...
const MenuUser = () => {
    ...
    const authBtn = (
        <div className="flex ms-20 space-x-3">
            ...
            <Link to="/home-register"><Button label={t('register')} className="bg-blackCustom  text-white font-poppins border border-none outline outline-none text-sm py-2 px-6" /></Link>
        </div>
    )
