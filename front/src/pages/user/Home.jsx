    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} >
            ...
            <main className="mt-5 mx-4">
                ...
                <motion.section className="mt-16 mx-16" initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
                ...
                <motion.article className="mt-20 mx-24" initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
                ...
                <motion.section className="mt-24 mx-16" initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
                ...
                <motion.article className="mt-24 mx-24" initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
                    <h1 className="text-center text-xl">{t('aboutTitle')}</h1>

                    <div className="grid grid-cols-2 mt-10">
                        <div>
                            <p className="mx-16 mt-6">{t('pAbout')}</p>
                            <Button label={t('knowMore')} className="bg-blackCustom mt-8 ms-16 font-poppins text-sm border border-none outline outline-none" />
                        </div>

                        <div className="bg-greenCustom shadow rounded p-8 mx-16">
                            <img src={aboutImg} width={400} height={400} alt="Promo" className="w-80 h-72 mx-auto flex justify-center mt-3" />
                        </div>
                    </div>
                </motion.article>
